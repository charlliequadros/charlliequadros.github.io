...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "produtoPerecivelValidator", function() { return produtoPerecivelValidator; });
function produtoPerecivelValidator(control) {
    var _a, _b;
    const produtoPerecivel = (_a = control.get('ProdutoPerecivel')) === null || _a === void 0 ? void 0 : _a.value;
    const dataValidadade = (_b = control.get('DataValidade')) === null || _b === void 0 ? void 0 : _b.value;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UnidadeValidator", function() { return UnidadeValidator; });
function UnidadeValidator(control) {
    var _a, _b;
    const unidadeMedida = (_a = control.get('unidadeMedida')) === null || _a === void 0 ? void 0 : _a.value;
    const quantidade = (_b = control.get('quantidade')) === null || _b === void 0 ? void 0 : _b.value;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dataFabricacaoValidator", function() { return dataFabricacaoValidator; });
function dataFabricacaoValidator(control) {
    ...
    if (((_a = control.get('DataValidade')) === null || _a === void 0 ? void 0 : _a.value) && ((_b = control.get('DataFabricacao')) === null || _b === void 0 ? void 0 : _b.value)) {
        let DataValidade = new Date((_c = control.get('DataValidade')) === null || _c === void 0 ? void 0 : _c.value);
        DataValidade.setDate(DataValidade.getDate() + 1);
        let DataFabricacao = new Date((_d = control.get('DataFabricacao')) === null || _d === void 0 ? void 0 : _d.value);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dataValidadeValidator", function() { return dataValidadeValidator; });
function dataValidadeValidator(control) {
    if (control.value === null)
        return null;
    let dataValidade = new Date(control.value);
    dataValidade.setDate(dataValidade.getDate() + 1);
...
/* harmony import */ var _cadastro_cadastro_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cadastro/cadastro.component */ "./src/app/cadastro/cadastro.component.ts");
/* harmony import */ var _listagem_listagem_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./listagem/listagem.component */ "./src/app/listagem/listagem.component.ts");
...
const routes = [
    ...
    { path: 'cadastro', component: _cadastro_cadastro_component__WEBPACK_IMPORTED_MODULE_2__["CadastroComponent"] },
    { path: 'cadastro/:id', component: _cadastro_cadastro_component__WEBPACK_IMPORTED_MODULE_2__["CadastroComponent"] },
    { path: 'listagem', component: _listagem_listagem_component__WEBPACK_IMPORTED_MODULE_3__["ListagemComponent"] }
];
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 22, vars: 1, consts: [["id", "slide-out", 1, "sidenav", "sidenav-fixed"], [1, "user-view"], [1, "background"], ["src", "../../assets/img/logo.png", 1, "logo"], ["routerLinkActive", "active"], ["routerLink", "/cadastro"], [1, "material-icons"], ["routerLink", "/listagem"], ["href", "#", "data-target", "slide-out", 1, "sidenav-trigger"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _listagem_listagem_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./listagem/listagem.component */ "./src/app/listagem/listagem.component.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var ng2_currency_mask__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ng2-currency-mask */ "./node_modules/ng2-currency-mask/__ivy_ngcc__/fesm2015/ng2-currency-mask.js");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [_angular_common__WEBPACK_IMPORTED_MODULE_7__["CurrencyPipe"], { provide: _angular_core__WEBPACK_IMPORTED_MODULE_1__["LOCALE_ID"], useValue: 'pt' },], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        ...
        _listagem_listagem_component__WEBPACK_IMPORTED_MODULE_6__["ListagemComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], ngx_mask__WEBPACK_IMPORTED_MODULE_11__["NgxMaskModule"], ng2_currency_mask__WEBPACK_IMPORTED_MODULE_8__["CurrencyMaskModule"],
        angular_datatables__WEBPACK_IMPORTED_MODULE_9__["DataTablesModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _cadastro_cadastro_component__WEBPACK_IMPORTED_MODULE_5__["CadastroComponent"],
                    _listagem_listagem_component__WEBPACK_IMPORTED_MODULE_6__["ListagemComponent"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"],
                ...
                providers: [_angular_common__WEBPACK_IMPORTED_MODULE_7__["CurrencyPipe"], { provide: _angular_core__WEBPACK_IMPORTED_MODULE_1__["LOCALE_ID"], useValue: 'pt' },],
...
/* harmony import */ var _ValidacoesCustomizadas_dataValidadeValidator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../ValidacoesCustomizadas/dataValidadeValidator */ "./src/app/ValidacoesCustomizadas/dataValidadeValidator.ts");
/* harmony import */ var _ValidacoesCustomizadas_dataFabricacaoValidator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../ValidacoesCustomizadas/dataFabricacaoValidator */ "./src/app/ValidacoesCustomizadas/dataFabricacaoValidator.ts");
/* harmony import */ var _ValidacoesCustomizadas_ProdutoPerecivelValidator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../ValidacoesCustomizadas/ProdutoPerecivelValidator */ "./src/app/ValidacoesCustomizadas/ProdutoPerecivelValidator.ts");
/* harmony import */ var _ValidacoesCustomizadas_UnidadeValidator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../ValidacoesCustomizadas/UnidadeValidator */ "./src/app/ValidacoesCustomizadas/UnidadeValidator.ts");
/* harmony import */ var _produto_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../produto.service */ "./src/app/produto.service.ts");
...
/* harmony import */ var ng2_currency_mask__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ng2-currency-mask */ "./node_modules/ng2-currency-mask/__ivy_ngcc__/fesm2015/ng2-currency-mask.js");
...
function CadastroComponent_span_6_Template(rf, ctx) { if (rf & 1) {
...
function CadastroComponent_div_34_span_4_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 23);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Campo data validade \u00E9 obrigat\u00F3rio");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function CadastroComponent_div_34_span_5_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 23);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "O produto se encontra vencido");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function CadastroComponent_div_34_Template(rf, ctx) { if (rf & 1) {
    ...
    var tmp_1_0 = null;
    const currVal_1 = (ctx_r3.formulario.controls.DataValidade == null ? null : ctx_r3.formulario.controls.DataValidade.errors == null ? null : ctx_r3.formulario.controls.DataValidade.errors.dataValidade) && ((tmp_1_0 = ctx_r3.formulario.get("DataValidade")) == null ? null : tmp_1_0.touched);
...
class CadastroComponent {
    constructor(formBuilder, produtoService, route) {
    ...
    alterarMascaraUnidadeMedida() {
        var _a;
        let unidadeMedida = (_a = this.formulario.get('unidadeMedida')) === null || _a === void 0 ? void 0 : _a.value;
...
CadastroComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CadastroComponent, selectors: [["app-cadastro"]], decls: 51, vars: 11, consts: [[3, "formGroup", "submit"], [1, "row"], [1, "input-field", "col", "s12"], ["id", "input_text", "type", "text", "data-length", "50", "formControlName", "nome"], ["for", "input_text", 1, "active"], ["class", "helper-text ", 4, "ngIf"], ["formControlName", "unidadeMedida", 3, "change"], ["value", "", "disabled", "", "selected", ""], ["value", "lt"], ["value", "kg"], ["value", "un"], ["id", "quantidadeId", "type", "text", "formControlName", "quantidade", 3, "mask"], ["for", "quantidadeId"], [1, "checkbox", "checkbox-circle"], ["type", "checkbox", "formControlName", "ProdutoPerecivel", 1, "filled-in"], ["class", "input-field col s12", 4, "ngIf"], ["id", "DataFabricacaoId", "type", "date", "formControlName", "DataFabricacao"], ["for", "DataFabricacaoId"], ["id", "precoId", "type", "text", "currencyMask", "", "formControlName", "preco", 3, "options"], ["for", "precoId"], [1, "btn-rigth"], ["type", "submit", 1, "btn", "btn-success", "btn-margin-rigth", 3, "disabled"], ["routerLink", "/listagem", 1, "btn", "btn-success", "btn-margin-rigth"], [1, "helper-text"], ["id", "DataValidadeId", "type", "date", "formControlName", "DataValidade"], ["for", "DataValidadeId"]], template: function CadastroComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CadastroComponent_Template_select_change_10_listener() { return ctx.alterarMascaraUnidadeMedida(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](11, "option", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](12, "Escolha uma op\u00E7\u00E3o");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](38, "Data fabrica\u00E7\u00E3o *");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](43, "Pre\u00E7o");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        var tmp_1_0 = null;
        const currVal_1 = (ctx.formulario.controls.nome == null ? null : ctx.formulario.controls.nome.errors == null ? null : ctx.formulario.controls.nome.errors.required) && ((tmp_1_0 = ctx.formulario.get("nome")) == null ? null : tmp_1_0.touched);
        var tmp_2_0 = null;
        const currVal_2 = (ctx.formulario.controls.nome == null ? null : ctx.formulario.controls.nome.errors == null ? null : ctx.formulario.controls.nome.errors.maxlength) && ((tmp_2_0 = ctx.formulario.get("nome")) == null ? null : tmp_2_0.touched);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CadastroComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _produto_service__WEBPACK_IMPORTED_MODULE_7__["ProdutoService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_8__["ActivatedRoute"] }]; }, null); })();
...
function ListagemComponent_tr_23_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListagemComponent_tr_23_Template_button_click_18_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const i_r2 = ctx.index; const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r3.mostrarModal(i_r2); });
...
class ListagemComponent {
    ...
    mostrarModal(id) {
        ...
        const instance = materialize_css_dist_js_materialize__WEBPACK_IMPORTED_MODULE_1__["Modal"].getInstance(elem);
        instance.open();
    }
    closeModal() {
        const elem = document.getElementById('modal1');
...
ListagemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ListagemComponent, selectors: [["app-listagem"]], decls: 35, vars: 2, consts: [["routerLink", "/cadastro/", 1, "btn", "btn-rigth"], [1, "row"], [1, "col", "s12"], ["datatable", "", "id", "example", 1, "table", "row-border", "hover", "responsive-table", 3, "dtOptions"], [4, "ngFor", "ngForOf"], ["id", "modal1", 1, "modal"], [1, "modal-content"], [1, "modal-footer"], [1, "blue", "btn-margin-rigth", "btn", 3, "click"], [1, "modal-close", "btn", "btn-margin-rigth", 3, "click"], [1, "btn-margin-rigth", "red", "btn-small", 3, "click"], [1, "material-icons"], [1, "btn-margin-rigth", "blue", "btn-small", 3, "routerLink"]], template: function ListagemComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](20, "Data Fabrica\u00E7\u00E3o");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](27, "Aten\u00E7\u00E3o");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListagemComponent_Template_a_click_31_listener() { return ctx.apagarProduto(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListagemComponent_Template_a_click_33_listener() { return ctx.closeModal(); });
...
module.exports = __webpack_require__(/*! E:\teste\projetoUnivali\DesafioUnivali\src\main.ts */"./src/main.ts");
